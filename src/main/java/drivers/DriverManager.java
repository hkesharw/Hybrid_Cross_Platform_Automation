        ...
        if (driver == null) {
            if (platform.equalsIgnoreCase("web")) {
                ...
                if (chromeDriverPath == null || chromeDriverPath.isBlank()) {
                    ...
                    System.out.println("[DriverManager] CHROME_DRIVER_PATH not set. Trying project path: " + chromeDriverPath);
                } else {
                ...
                if (!driverFile.exists()) {
                    throw new IllegalStateException("ChromeDriver executable not found. " +
                            "Download chromedriver.exe and place it in the project 'src/main/java/drivers' folder, or set CHROME_DRIVER_PATH to the full path.");
                }
